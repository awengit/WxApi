...
<script type="text/javascript">
	...
	PostDataToServ('postData', 'POST', '/User/EditEx.html', '/User/List.html',
			function(data) {
		...
		<form class="layui-form layui-form-pane" action="">
			...
			<div class="layui-field-box">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input name="LoginName" lay-verify="LoginName" placeholder="用户名" autocomplete="off"
							class="layui-input" type="text" value="Liww" maxlength="20" readonly="">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input name="LoginPsw" lay-verify="LoginPsw" placeholder="用户密码" autocomplete="off"
							class="layui-input" type="text" value="" maxlength="20">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input checked=&quot;&quot; value="1" lay-filter="WxAccounts" name="WxAccounts"
							lay-skin="primary" title="测试账号" type="checkbox" /> <input checked=&quot;&quot; value="2"
							lay-filter="WxAccounts" name="WxAccounts" lay-skin="primary" title="李锐-测试账号" type="checkbox" />
						<input value="3" lay-filter="WxAccounts" name="WxAccounts" lay-skin="primary" title="1"
							type="checkbox" /> <input value="6" lay-filter="WxAccounts" name="WxAccounts"
							lay-skin="primary" title="2" type="checkbox" />
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
