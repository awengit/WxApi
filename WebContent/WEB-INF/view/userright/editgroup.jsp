...
<script type="text/javascript">
	PostDataToServ('postData', 'POST', '/UserRight/EditGroupEx.html',
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input name="Title" lay-verify="required" placeholder="标题" autocomplete="off"
							class="layui-input" type="text" value="微信用户管理" maxlength="20">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input name="OrderNum" lay-verify="required" placeholder="排序" autocomplete="off"
							class="layui-input" type="text" value="5" maxlength="5">
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
